...
export default function Testimonial() {
  return (
    <section className="bg-warmGray text-darkMutedRed pt-28 xl:pt-0 xl:pb-10 relative">
      ...
      />
      <div className="absolute space-y-3 top-[4%] left-[5%] xl:left-[10%] xl:top-[15%]">
        <p className="text-sm font-semibold text-center xl:text-start">TESTIMONIALS</p>
        ...
        {testimonials.map((item, index) => (
          ...
          >
            ...
            <div className="md:w-1/2 space-y-5 mb-5 flex items-end ">
              <div className="bg-grayishBlue py-16 xl:py-10 px-4 xl:px-6 space-y-12  md:absolute lg:static md:w-[60%] lg:w-full h-fit">
